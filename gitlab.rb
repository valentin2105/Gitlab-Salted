...
{%- set gitlab_url = pillar[hostname_apps]['gitlab']['url'] -%}
{%- set gitlab_smtp = pillar[hostname_apps]['gitlab']['smtp'] -%}
{%- set gitlab_smtp_port = pillar[hostname_apps]['gitlab']['smtp_port'] -%}
{%- set gitlab_smtp_username = pillar[hostname_apps]['gitlab']['smtp_username'] -%}
{%- set gitlab_smtp_password = pillar[hostname_apps]['gitlab']['smtp_password'] -%}
{%- set gitlab_smtp_domain = pillar[hostname_apps]['gitlab']['smtp_domain'] -%}
{%- set gitlab_email_from = pillar[hostname_apps]['gitlab']['email_from'] -%}
...
# user['git_user_name'] = "GitLab"
 user['git_user_email'] = "{{ gitlab_email_from }}"
